...
>
    ...
    <div x-show="!isLoadingLibrary && !isScanning && !scanError" x-cloak class="text-center text-sm text-gray-500">
        Starting camera...
    </div>
    ...
    <style>
        ...
        #qr-reader-instance video { border-radius: 0.375rem; }
        #qr-reader-instance { padding: 0; }
    </style>
</div>
