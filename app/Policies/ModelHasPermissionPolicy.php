...
class ModelHasPermissionPolicy
{
    ...
    {
        return $user->checkPermissionTo('delete-any ModelHasPermission');
    }
    ...
    {
        return $user->checkPermissionTo('restore-any ModelHasPermission');
    }

    /**
     * Determine whether the user can replicate the model.
     */
    public function replicate(User $user, ModelHasPermission $modelhaspermission): bool
    {
        return $user->checkPermissionTo('replicate ModelHasPermission');
    }
    ...
    {
        return $user->checkPermissionTo('reorder ModelHasPermission');
    }
    ...
    {
        return $user->checkPermissionTo('force-delete-any ModelHasPermission');
    }
}
