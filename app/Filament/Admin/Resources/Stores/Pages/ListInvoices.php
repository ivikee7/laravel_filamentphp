    ...
    protected function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('user.name')->label('Name')->sortable()->searchable()->wrap(),
                TextColumn::make('user.father_name')->label('Father Name')->sortable()->searchable()->wrap()->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('user.mother_name')->label('Mother Name')->sortable()->searchable()->wrap()->toggleable(isToggledHiddenByDefault: true),
                ...
                TextColumn::make('remarks')->label('Remarks')->searchable()->wrap()->toggleable(isToggledHiddenByDefault: true),
