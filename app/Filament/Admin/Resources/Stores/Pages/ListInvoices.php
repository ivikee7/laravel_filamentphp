    ...
    protected function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('user.father_name')->label('Father Name')->sortable()->searchable()->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('user.mother_name')->label('Mother Name')->sortable()->searchable()->toggleable(isToggledHiddenByDefault: true),
