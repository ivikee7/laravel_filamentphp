...
class BookAuthorResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListBookAuthors::route('/'),
            'create' => Pages\CreateBookAuthor::route('/create'),
            'view' => Pages\ViewBookAuthor::route('/{record}'),
            'edit' => Pages\EditBookAuthor::route('/{record}/edit'),
        ];
    }
